            ...
            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
                ...
                <td colspan="2">
                    <div>
                        ...
                        <#assign shipmentItem = shipmentPackageContent.getRelatedOne("ShipmentItem")?if_exists>
                        <#if shipmentItem?has_content>
                            <#assign product = shipmentItem.getRelatedOne("Product")?if_exists>
                    ...
                    <div>
                        ...
                        <select name="shipmentItemSeqId">
                            <#list shipmentItems as shipmentItem>
                                ...
                                <option value="${shipmentItem.shipmentItemSeqId}">${shipmentItem.shipmentItemSeqId} <#if productUom?has_content> - ${productUom.abbreviation}</#if></option>
                            </#list>
                        </select>
                    </div>
                </td>
