                        ...
                        <fo:table-body>
                               <#list shipmentItemsDatas as shipmentItemsData>
                                ...
                                <fo:table-row>
                                    ...
                                    <fo:table-cell padding="2pt">
                                        <fo:block text-align="center">${shippedQuantity}<#if productUom?has_content> ${productUom.abbreviation}</#if></fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell padding="2pt">
                                        <fo:block text-align="center">${packageQuantity}<#if productUom?has_content> ${productUom.abbreviation}</#if></fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <#list itemIssuances as itemIssuance>
                                       <fo:table-row>
                                        ...
                                        <fo:table-cell padding="2pt">
                                           ...
                                           <fo:table-cell padding="2pt">
                                            <fo:block text-align="center">${itemIssuance.quantity}<#if productUom?has_content> ${productUom.abbreviation}</#if></fo:block>
                                        </fo:table-cell>
                                        <fo:table-cell padding="2pt">
