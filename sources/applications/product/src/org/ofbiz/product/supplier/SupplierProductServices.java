...
public class SupplierProductServices {
    ...
    public static Map<String, Object> getSuppliersForProduct(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            // filter the list down by the quantityUomId if one is provided
            String quantityUomId = (String) context.get("quantityUomId");
            if (quantityUomId != null) {
                supplierProducts = EntityUtil.filterByAnd(supplierProducts, UtilMisc.toMap("quantityUomId", quantityUomId));
            }
