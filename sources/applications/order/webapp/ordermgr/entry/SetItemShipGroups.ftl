            ...
            <#list 1..shoppingCart.getShipGroupSize() as currIndex>
              ...
              <#list shoppingCartItems as shoppingCartItem>
                ...
                <#if shoppingCartItem.useAlternaltiveUomQty()>
                    <#assign piecesIncluded = shoppingCartItem.getAlternativeConversionFactor()?default(1)>
                ...
                <tr>
                  ...
                  <td>
                    <div>${shipGroupItemQuantity / piecesIncluded}<#if quantityUom?has_content> ${quantityUom.get("description",locale)?default(quantityUom.uomId)}</#if></div>
                  </td>
                  <td>
                    <div><input type="text" name="quantity_o_${rowCount}" value="${shipGroupItemQuantity / piecesIncluded}"/></div>
                  </td>
                  <td>
                    <div>
