...
<div class="screenlet">
    ...
    <div class="screenlet-body">
        <table width="100%" border="0" cellpadding="0">
          <tr valign="bottom">
            <td width="60%"><span><b>${uiLabelMap.ProductProduct}</b></span></td>
            <td width="10%" align="right"><span><b>${uiLabelMap.OrderQuantity}</b></span></td>
                ...
                <td align="right" valign="top">
                  <#if orderItem.altQuantity?has_content>
                    ...
                    <#if productForUom?has_content>
                      ...
                      <div nowrap="nowrap">${orderItem.altQuantity?string.number}<#if quantityUom?has_content> ${quantityUom.get("description",locale)?default(quantityUom.uomId)}</#if></div>
                      <div style="font-size: xx-small;" nowrap="nowrap"><i>${orderItem.quantity?string.number}<#if productUom?has_content> ${productUom.get("description",locale)?default(productUom.uomId)}</#if></i></div>
                  <#else>
                      <div nowrap="nowrap">${orderItem.quantity?string.number}</div>
                  </#if>
                </td>
                <td align="right" valign="top">
                  <#if orderItem.altUnitPrice?has_content>
                      <div nowrap="nowrap"><@ofbizCurrency amount=orderItem.altUnitPrice isoCode=currencyUomId/></div>
                      <div style="font-size: xx-small;" nowrap="nowrap"><i><@ofbizCurrency amount=orderItem.unitPrice isoCode=currencyUomId/></i></div>
