...
<script language="JavaScript" type="text/javascript">
    ...
    function checkProductAlternativeUoms(e) {
        ...
        var quantityValue = document.quickaddform.quantity.value;
        //Check if product exists and has defined quantityUomId
        jQuery.ajax({
            url: '/ordermgr/control/checkProductAlternativeQuantity',
            async: false,
            type: 'POST',
            data: {"productId" : selectedValue, "quantity" : quantityValue},
    ...
    function checkProductAlternativeUomsForQuantity(e) {
        ...
        var productValue = document.quickaddform.add_product_id.value;
        ...
        jQuery.ajax({
            ...
            async: false,
            type: 'POST',
            data: {"productId" : productValue, "quantity" : selectedValue},
            success: function(data) {
                jQuery('#showQuantity').html(data);
            }
        });
            ...
            <form method="post" action="<@ofbizUrl>additem</@ofbizUrl>" name="quickaddform" style="margin: 0;">
              <table border="0">
                <tr>
                  ...
                  <td>
                    <span class='tabletext'>
                      ...
                      <@htmlTemplate.lookupField formName="quickaddform" name="add_product_id" id="add_product_id" value="${productId!}" fieldFormName="${fieldFormName}" event="onBlur" action="javascript:checkProductAlternativeUoms(this);"/>
                ...
                <tr>
                  ...
                  <td>
                      <div>
                      <input type="text" size="6" name="quantity" value="" onblur="javascript:checkProductAlternativeUomsForQuantity(this);"/>
