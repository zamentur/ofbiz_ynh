...
<!--
    ...
    function addItem() {
        ...
        document.configform.quantityUomId.value = document.getElementById("quantityUomId").value;
    ...
    function checkProductAlternativeUoms(e) {
        ...
        var quantityValue = document.addform.quantity.value;
    ...
    function checkProductAlternativeUomsForQuantity(e) {
        ...
        var productValue = document.addform.add_product_id.value;
        ...
        <#else>
          <#if inStock>
            ...
            <#else>
              ...
              <div>
                  <input type="text" size="5" name="quantity" value="${quantity}" onblur="javascript:checkProductAlternativeUomsForQuantity(this);"/>
  ...
  <tr>
    <td colspan="2">
      <form name="configform" id="configFormId" method="post" action="<@ofbizUrl>product<#if requestAttributes._CURRENT_VIEW_?exists>/${requestAttributes._CURRENT_VIEW_}</#if></@ofbizUrl>">
        ...
        <input type='hidden' name='quantityUomId' value='' />
