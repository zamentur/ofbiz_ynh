            ...
            <fo:table-body>
                <#list orderItemList as orderItem>
                    ...
                    <#if orderItem.altQuantity?has_content>
                        <#assign piecesIncluded = Static["org.ofbiz.order.order.OrderReadHelper"].getAlternativeConversionFactor(orderItem)>
                    ...
                    <#assign remainingQuantity = (orderItem.quantity?default(0) - orderItem.cancelQuantity?default(0)) / piecesIncluded>
                    ...
                    <fo:table-row>
                        ...
                        <fo:table-cell text-align="right">
                            <fo:block>${remainingQuantity}<#if quantityUom?has_content> ${quantityUom.abbreviation!}</#if></fo:block>
                        </fo:table-cell>
                        <fo:table-cell text-align="right">
                            <fo:block><#if orderItem.altUnitPrice?has_content><@ofbizCurrency amount=orderItem.altUnitPrice isoCode=currencyUomId/><#else><@ofbizCurrency amount=orderItem.unitPrice isoCode=currencyUomId/></#if></fo:block>
                        </fo:table-cell>
                        <fo:table-cell text-align="right">
                            <fo:block>
