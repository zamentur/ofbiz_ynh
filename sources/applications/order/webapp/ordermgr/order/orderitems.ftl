        ...
        <div class="screenlet-body">
            <table class="order-items basic-table" cellspacing='0'>
                <tr valign="bottom" class="header-row">
                    ...
                    <td width="23%">${uiLabelMap.CommonStatus}</td>
                    <td width="6%">${uiLabelMap.OrderQuantity}</td>
                    <td width="19%" align="right">${uiLabelMap.OrderUnitStockList}</td>
                ...
                <#else>
                    ...
                    <#list orderItemList as orderItem>
                        <#assign piecesIncluded = 1.0>
                        <#if orderItem.altQuantity?has_content>
                            <#assign piecesIncluded = orderReadHelper.getAlternativeConversionFactor(orderItem)>
                            <#assign quantityUom = orderItem.getRelatedOne("QuantityUom")?if_exists>
                            <#assign productForUom = orderItem.getRelatedOne("Product")?if_exists/>
                            <#if productForUom?has_content>
                                <#--Retrieve qty uom from product -->
                                <#assign productUom = productForUom.getRelatedOne("QuantityUom")?if_exists>
                            </#if>
                        </#if>
                            ...
                            <#else>
                                <td colspan="7">
                                    <div class="order-item-description">
                                        ...
                                        <#if orderItem.altQuantity?has_content>
                                            <div>
                                            ${uiLabelMap.ProductPackaging}: <#if quantityUom?has_content> ${quantityUom.get("description",locale)?default(quantityUom.uomId)}</#if>
                                            <br/>
                                            </div>
                                        </#if>
                        ...
                        <tr<#if itemClass == "1"> class="alternate-row"</#if>>
                            ...
                            <#else>
                                        ...
                                        <div class="screenlet-body">
                                            <table>
                                                <tr valign="top">
                                                    ...
                                                    <#if orderItem.altQuantity?has_content>
                                                        <td>${orderItem.altQuantity?default(0)?string.number}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> (${orderItem.quantity?default(0)?string.number}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>) </td>
                                                    <#else>
                                                        <td>${orderItem.quantity?default(0)?string.number}</td>
                                                    </#if>
                                                    <td><b>${uiLabelMap.OrderShipRequest}</b></td>
                                                    <td>${orderReadHelper.getItemReservedQuantity(orderItem) / piecesIncluded}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${orderReadHelper.getItemReservedQuantity(orderItem)}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if></td>
                                                </tr>
                                                <tr valign="top">
                                                    <td><b>${uiLabelMap.OrderCancelled}</b></td>
                                                    <td>${orderItem.cancelQuantity?default(0) / piecesIncluded}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${orderItem.cancelQuantity?default(0)?string.number}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if></td>
                                                    <#if orderHeader.orderTypeId == "SALES_ORDER">
                                                        <#if pickedQty gt 0 && orderHeader.statusId == "ORDER_APPROVED">
                                                            <td><font color="red"><b>${uiLabelMap.OrderQtyPicked}</b></font></td>
                                                            <td><font color="red">${pickedQty?default(0) / piecesIncluded}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${pickedQty?default(0)?string.number}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if></font></td>
                                                        <#else>
                                                            <td><b>${uiLabelMap.OrderQtyPicked}</b></td>
                                                            <td>${pickedQty?default(0) / piecesIncluded}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${pickedQty?default(0)?string.number}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if></td>
                                                        </#if>
                                                    <#else>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <#if remainingQuantity?has_content && remainingQuantity lt 0 >
                                                        <#assign remainingQuantity = 0>
                                                    </#if>
                                                    <td>${remainingQuantity?default(0) / piecesIncluded}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${remainingQuantity?default(0)?string.number}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if></td>
                                                    <td><b>${uiLabelMap.OrderQtyShipped}</b></td>
                                                    <td>${shippedQuantity?default(0) / piecesIncluded}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${shippedQuantity?default(0)?string.number}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if></td>
                                                </tr>
                                                <tr valign="top">
                                                    <td><b>${uiLabelMap.OrderShortfalled}</b></td>
                                                    <td>${shortfalledQuantity?default(0) / piecesIncluded}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${shortfalledQuantity?default(0)?string.number}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <#elseif orderHeader.orderTypeId == "PURCHASE_ORDER">
                                                            <#assign itemWaitingQuantity = ((orderItem.quantity?default(0) - orderItem.cancelQuantity?default(0)) - totalReceived?double)>
                                                            <#if itemWaitingQuantity?has_content && itemWaitingQuantity lt 0 >
                                                                <#assign itemWaitingQuantity = 0>
                                                            </#if>
                                                            ${itemWaitingQuantity / piecesIncluded}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${itemWaitingQuantity}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if>
                                                        <#elseif orderHeader.orderTypeId == "SALES_ORDER">
                                                            <#assign itemWaitingQuantity = ((orderItem.quantity?default(0) - orderItem.cancelQuantity?default(0)) - shippedQuantity?double)>
                                                            <#if itemWaitingQuantity?has_content && itemWaitingQuantity lt 0 >
                                                                <#assign itemWaitingQuantity = 0>
                                                            </#if>
                                                            ${itemWaitingQuantity / piecesIncluded}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${itemWaitingQuantity}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if>
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td>${orderReadHelper.getOrderItemInvoicedQuantity(orderItem)?default(0) / piecesIncluded}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${orderReadHelper.getOrderItemInvoicedQuantity(orderItem)?default(0)}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if></td>
                                                    <td><b>${uiLabelMap.OrderReturned}</b></td>
                                                    <td>${returnQuantityMap.get(orderItem.orderItemSeqId)?default(0) / piecesIncluded}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${returnQuantityMap.get(orderItem.orderItemSeqId)?default(0)}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                                ...
                                <td align="right" valign="top" nowrap="nowrap">
                                    <#if orderItem.altQuantity?has_content>
                                        <@ofbizCurrency amount=orderItem.altUnitPrice isoCode=currencyUomId/> (<@ofbizCurrency amount=orderItem.unitPrice isoCode=currencyUomId/>) 
                                    <#else>
                        ...
                        <#if orderItemShipGroupAssocs?has_content>
                            <#list orderItemShipGroupAssocs as shipGroupAssoc>
                                ...
                                <tr<#if itemClass == "1"> class="alternate-row"</#if>>
                                    ...
                                    <td align="center">
                                        ${(shipGroupAssoc.quantity / piecesIncluded)?string.number}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${shipGroupAssoc.quantity?string.number}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if>
                                    </td>
                                    <td colspan="4">&nbsp;</td>
                                </tr>
                            </#list>
                        ...
                        <#if orderItemShipGrpInvResList?exists && orderItemShipGrpInvResList?has_content>
                            <#list orderItemShipGrpInvResList as orderItemShipGrpInvRes>
                                <tr<#if itemClass == "1"> class="alternate-row"</#if>>
                                    ...
                                    <td align="center">
                                        ${(orderItemShipGrpInvRes.quantity / piecesIncluded)?string.number}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${orderItemShipGrpInvRes.quantity?string.number}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if>&nbsp;
                                    </td>
                                    <td>
                                        <#if (orderItemShipGrpInvRes.quantityNotAvailable?has_content && orderItemShipGrpInvRes.quantityNotAvailable > 0)>
                        ...
                        <#if orderShipments?has_content>
                            <#list orderShipments as orderShipment>
                                <tr<#if itemClass == "1"> class="alternate-row"</#if>>
                                    ...
                                    <td align="center">
                                        ${(orderShipment.quantity / piecesIncluded)?string.number}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${orderShipment.quantity?string.number}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if>&nbsp;
                                    </td>
                                    <td colspan="4">&nbsp;</td>
                                </tr>
                            </#list>
                        ...
                        <#if itemIssuances?has_content>
                            ...
                            <tr<#if itemClass == "1"> class="alternate-row"</#if>>
                                ...
                                <td align="center">
                                    ${((itemIssuance.quantity?default(0) - itemIssuance.cancelQuantity?default(0)) / piecesIncluded)?string.number}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${itemIssuance.quantity?default(0) - itemIssuance.cancelQuantity?default(0)}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if>&nbsp;
                                </td>
                                <td colspan="4">&nbsp;</td>
                            </tr>
                            </#list>
                        ...
                        <#if shipmentReceipts?has_content>
                            <#list shipmentReceipts as shipmentReceipt>
                                <tr<#if itemClass == "1"> class="alternate-row"</#if>>
                                    ...
                                    <td align="center">
                                        ${(shipmentReceipt.quantityAccepted?default(0) / piecesIncluded)?string.number}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${shipmentReceipt.quantityAccepted?default(0)}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if>&nbsp;/&nbsp;${(shipmentReceipt.quantityRejected?default(0) / piecesIncluded)?string.number}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if> <#if orderItem.altQuantity?has_content>(${shipmentReceipt.quantityRejected?default(0)}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)</#if>
                                    </td>
                                    <td colspan="4">&nbsp;</td>
                                </tr>
                            </#list>
