    ...
    <div class="screenlet-body">
        ...
        <#else>
            ...
            <table class="basic-table order-items" cellspacing="0">
                <tr class="header-row">
                    <td width="40%" style="border-bottom:none;">${uiLabelMap.ProductProduct}</td>
                    <td width="20%" style="border-bottom:none;">${uiLabelMap.CommonStatus}</td>
                    <td width="10%" style="border-bottom:none;" class="align-text">${uiLabelMap.OrderQuantity}</td>
                          ...
                          <#else>
                              ...
                              <td class="align-text" valign="top" nowrap="nowrap">
                                ...
                                <#else>
                                  ...
                                  <#if orderItem.altQuantity?has_content>
                                      ${uiLabelMap.OrderOrdered}:&nbsp;${(orderItem.quantity?default(0)/ piecesIncluded)?string.number}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if>&nbsp;&nbsp;(${orderItem.quantity?default(0)}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)<br />
                                      ${uiLabelMap.OrderCancelled}:&nbsp;${(orderItem.cancelQuantity?default(0)/ piecesIncluded)?string.number}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if>&nbsp;&nbsp;(${orderItem.cancelQuantity?default(0)}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)<br />
                                      ${uiLabelMap.OrderRemaining}:&nbsp;${remainingQuantity/ piecesIncluded}<#if quantityUom?has_content> ${quantityUom.abbreviation?default(quantityUom.uomId)}</#if>&nbsp;&nbsp;(${remainingQuantity?default(0)}<#if productUom?has_content> ${productUom.abbreviation?default(productUom.uomId)}</#if>)<br />
                                  <#else>
                              ...
                              <td class="align-text" valign="top" nowrap="nowrap">
                                  ...
                                  <#if orderItem.altQuantity?has_content>
                                      <#if (allowPriceChange)>
                                          ...
                                          <input type="text" size="8" name="ipm_${orderItem.orderItemSeqId}" value="<@ofbizAmount amount=orderItem.altUnitPrice/>"/>
                                          &nbsp;<input type="checkbox" name="opm_${orderItem.orderItemSeqId}" value="Y"/>
                                      <#else>
                                          <div><@ofbizCurrency amount=orderItem.altUnitPrice isoCode=currencyUomId/> / <@ofbizCurrency amount=orderItem.unitListPrice isoCode=currencyUomId/></div>
                                      </#if>
                                  <#else>
                                      <#if (allowPriceChange)>
                      ...
                      <#if orderItemShipGroupAssocs?has_content>
                          ...
                          <#list orderItemShipGroupAssocs as shipGroupAssoc>
                              ...
                              <tr>
                                  ...
                                  <td align="center">
                                      <#if orderItem.altQuantity?has_content>
                                          <input type="text" name="iqm_${shipGroupAssoc.orderItemSeqId}:${shipGroupAssoc.shipGroupSeqId}" size="6" value="${(shipGroupAssoc.quantity?default(0) / piecesIncluded)?string.number}"/><#if quantityUom?has_content> ${quantityUom.get("abbreviation",locale)?default(quantityUom.uomId)}</#if>
                                      <#else>
