        ...
        if ("PROMO_SERVICE".equals(productPromoActionEnumId)) {
            ...
            if (!allowMultipleGwp && itemLoc != null) {
                ...
                try {
                    ...
                    gwpItem = ShoppingCartItem.makeItem(null, product, null, quantity, null, null, null, null, null, null, null, null, prodCatalogId, null, null, null, dispatcher, cart, Boolean.FALSE, Boolean.TRUE, null, null, Boolean.FALSE, Boolean.FALSE);
