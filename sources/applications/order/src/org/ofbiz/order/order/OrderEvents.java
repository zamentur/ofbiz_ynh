...
public class OrderEvents {
    ...
    public static String checkOrderProductAlternativeQuantity(HttpServletRequest request, HttpServletResponse response) {
        Delegator delegator = (Delegator) request.getAttribute("delegator");
        Locale locale = UtilHttp.getLocale(request);
        String  orderId = request.getParameter("orderId");
            ...
            if(product != null){
                ...
                if (UtilValidate.isNotEmpty(orderHeader)) {
                    ...
                    if (orderTypeId.equals("PURCHASE_ORDER")) {
                        ...
                        productPriceValues = orh.getSupplierProductList(productId, quantity, null, dispatcher);
                    } else if (orderTypeId.equals("SALES_ORDER")) {
                        //Check product prices
                        String productStoreId = orderHeader.getString("productStoreId");
                        productPriceValues = orh.getProductSalesProductPrices(productId, quantity, null, productStoreId, null, "PURCHASE", null, null, dispatcher);
                    }
