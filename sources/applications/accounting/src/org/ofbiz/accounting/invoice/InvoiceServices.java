    ...
    public static Map<String, Object> createInvoiceForOrder(DispatchContext dctx, Map<String, Object> context) {
        ...
        try {
            ...
            for (GenericValue currentValue : billItems) {
                ...
                if (UtilValidate.isNotEmpty(orderItem.get("altUnitPrice"))) {
                    ...
                    BigDecimal totalPrice = orderItem.getBigDecimal("altUnitPrice");
                    BigDecimal altQuantity = orderItem.getBigDecimal("altQuantity");
                    if (UtilValidate.isNotEmpty(altQuantity)) {
                        totalPrice = totalPrice.multiply(altQuantity);
                    }
                    BigDecimal orderedQuantity = OrderReadHelper.getOrderItemQuantity(orderItem);
