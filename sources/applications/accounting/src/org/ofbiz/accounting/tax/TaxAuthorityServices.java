...
public class TaxAuthorityServices {
    ...
    public static Map<String, Object> rateProductTaxCalcForDisplay(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        try {
            ...
            if ("Y".equals(productStore.getString("showPricesWithVatTax"))) {
                ...
                List<GenericValue> taxAdustmentList = getTaxAdjustments(delegator, product, productStore, null, billToPartyId, taxAuthoritySet, basePrice, quantity, amount, shippingPrice, ZERO_BASE, quantityUomId);
    ...
    public static Map<String, Object> rateProductTaxCalc(DispatchContext dctx, Map<String, ? extends Object> context) {
        ...
        for (int i = 0; i < itemProductList.size(); i++) {
            ...
            String quantityUomId = itemQuantityUomIdList != null ? itemQuantityUomIdList.get(i) : null;
            BigDecimal shippingAmount = itemShippingList.get(i);
            List<GenericValue> taxList = null;
            if (shippingAddress != null) {
                taxList = getTaxAdjustments(delegator, product, productStore, payToPartyId, billToPartyId, taxAuthoritySet, itemPrice, itemQuantity, itemAmount, shippingAmount, ZERO_BASE, quantityUomId);
            }
    ...
    private static List<GenericValue> getTaxAdjustments(Delegator delegator, GenericValue product, GenericValue productStore, 
        ...
        return getTaxAdjustments(delegator, product, productStore, payToPartyId, billToPartyId, taxAuthoritySet, itemPrice, itemQuantity, itemAmount, shippingAmount, orderPromotionsAmount, null);
    }

    private static List<GenericValue> getTaxAdjustments(Delegator delegator, GenericValue product, GenericValue productStore, 
            String payToPartyId, String billToPartyId, Set<GenericValue> taxAuthoritySet, 
            BigDecimal itemPrice, BigDecimal itemQuantity, BigDecimal itemAmount, 
            BigDecimal shippingAmount, BigDecimal orderPromotionsAmount, String quantityUomId) {
            ...
            for(GenericValue taxAuthorityRateProduct : filteredList) {
                ...
                if (product != null && taxAuthPartyId != null && taxAuthGeoId != null) {
                    ...
                    if (UtilValidate.isNotEmpty(quantityUomId)) {
                        priceFindMap.put("quantityUomId", quantityUomId);
                    }
